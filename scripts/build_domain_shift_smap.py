...
def main():
    ...
    ap.add_argument("--data_root", default="data/smap")
    ap.add_argument("--out_root", default="data/smap_experiments")
    ap.add_argument("--channels", default=None, help="Comma-separated channel ids to include, e.g. A-1,A-2")
    ...
    ap.add_argument(
        "--allow_cross_prefix",
        action="store_true",
        help="If set, allow cross-prefix target channels. By default, SMAP experiments stay within the same channel prefix family.",
    )
